  ...
  factory Post.fromMap(Map<String, dynamic> map) {
    try {
      return Post(
        ...
        upvotes: (map['upvotes'] as List<dynamic>?)
                ?.map<String>((dynamic item) => item.toString())
                .toList() ??
            [],
        downvotes: (map['downvotes'] as List<dynamic>?)
                ?.map<String>((dynamic item) => item.toString())
                .toList() ??
            [],
        commentCount:
      ...
      return Post(
        ...
        communityName: 'Error: ${e.toString()}',
        communityProfilePic: 'Error: ${e.toString()}',
        upvotes: [],
        downvotes: [],
        commentCount: 0,
        username: 'Error: ${e.toString()}',
        uid: 'Error: ${e.toString()}',
