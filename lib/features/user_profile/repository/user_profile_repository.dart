...
class UserProfileRepository {
  ...
  FutureVoid updateUserStatus(UserModel user) async {
    try {
      return right(_users.doc(user.uid).update({
        'isNew': false,
      }));
  ...
  FutureVoid addBlockedUser(UserModel user, String uid) async {
    try {
      return right(_users.doc(user.uid).update({
  ...
  FutureVoid removeBlockedUser(UserModel user, String uid) async {
    try {
      return right(_users.doc(user.uid).update({
