...
import 'package:bu_connect/features/community/repository/community_repository.dart';
...
final userCommunitiesProvider = StreamProvider.family((ref, String uid) {
  ...
  return communityController.getOtherUserCommunities(uid);
});
...
class CommunityController extends StateNotifier<bool> {
  ...
  Stream<List<Community>> getOtherUserCommunities(String uid) {
    return _communityRepository.getOtherUsersCommunities(uid);
  }
  ...
  void removeUser(
    ...
    final res = await _communityRepository.removeUser(communityName, uid);
    res.fold((l) => showSnackBar(context, l.message),
        (r) => Routemaster.of(context).pop());
  }
